                    ...
                    <div class="col-lg-7 col-xl-6 col-xxl-5 mx-auto mt-n20">
                        <div class="card">
                            <div class="card-body p-11 text-center">
                                ...
                                <form class="text-start mb-3" action="/register" method="POST">
                                    @csrf
                                    <input type="text" class="form-control" placeholder="Name" value="2" name="role_id" style="display: none;">
                                    <div class="form-floating mb-4">
                                        <input type="text" class="form-control" placeholder="Name" name="name">
                                        <label for="name">Nama</label>
                                    </div>
                                    <div class="form-floating mb-4">
                                        <input type="text" class="form-control" placeholder="Name" name="pekerjaan">
                                        <label for="pekerjaan">Pekerjaan</label>
                                    </div>
                                    <div class="form-floating mb-4">
                                        <input type="number" class="form-control" placeholder="Name" name="umur">
                                        <label for="umur">Umur</label>
                                    </div>
                                    <div class="form-floating mb-4">
                                        <input type="text" class="form-control" placeholder="Name" name="alamat">
                                ...
                                <!-- /form -->
                                <p class="mb-0">Already have an account? <a href="/login" class="hover">Sign
                                        in</a></p>
