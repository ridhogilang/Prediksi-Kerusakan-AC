                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                            <img src="{{ asset('assets/profile.png') }}" width="20" alt="" />
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="/" class="dropdown-item ai-icon">
                                ...
                                <span class="ml-2">Menu Utama</span>
                            </a>
                        </div>
                    </li>
                </ul>
...
<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            <li><a href="/datatraining" class="ai-icon" aria-expanded="false">
                    <i class="flaticon-381-settings-2"></i>
                    <span class="nav-text">Data Training</span>
                </a>
            </li>
            <li><a href="/datalabel" class="ai-icon" aria-expanded="false">
                    <i class="flaticon-381-settings-2"></i>
                    <span class="nav-text">Data Label</span>
                </a>
            </li>
            <li><a href="/datatesting" class="ai-icon" aria-expanded="false">
                    <i class="flaticon-381-settings-2"></i>
                    <span class="nav-text">Data Testing User</span>
                </a>
            </li>
            <li><a href="/registrasiadmin" class="ai-icon" aria-expanded="false">
                    <i class="flaticon-381-settings-2"></i>
