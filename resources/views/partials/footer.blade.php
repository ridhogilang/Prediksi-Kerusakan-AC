        ...
        <div class="row gy-6 gy-lg-0">
            <div class="col-md-4 col-lg-3">
                <div class="widget">
                    <img class="mb-4" src="./assets/img/logo-light.png" srcset="./assets/img/logo-light@2x.png 2x"
                        alt="" />
                    <p class="mb-4">© 2023 Artivicial Intelegent. <br class="d-none d-lg-block" />Universitas Janabadra.</p>
            ...
            <div class="col-md-4 col-lg-3">
                <div class="widget">
                    ...
                    <a href="/cdn-cgi/l/email-protection#6d4e"><span class="__cf_email__"
                            data-cfemail="5c35323a331c39313d3530723f3331">[email&#160;protected]</span></a><br /> 00
                    (123) 456 78 90
                </div>
                <!-- /.widget -->
            </div>
            ...
            <div class="col-md-4 col-lg-3">
                <div class="widget">
                    <h4 class="widget-title text-white mb-3">Quick Acces</h4>
                    <ul class="list-unstyled  mb-0">
                        <li><a href="/">Home</a></li>
                        <li><a href="/tutorial">Tutorial</a></li>
                        <li><a href="/kerusakan">Jenis Kerusakan</a></li>
                        <li><a href="/about">About</a></li>
                        <li><a href="/hitung">Prediksi</a></li>
                    </ul>
                </div>
                <!-- /.widget -->
            </div>
